...
extensions = ['sphinx.ext.todo', 'docs.envy']
...
project = 'envytools'
copyright = '2013, Marcelina Kościelnicka'
...
texinfo_documents = [
  ('index', 'hwdocs', 'nVidia Hardware Documentation',
   'Marcelina Kościelnicka', 'hwdocs', 'One line description of project.',
   'Miscellaneous'),
]
